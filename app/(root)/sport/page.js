      ...
      <div className="mx-auto mt-4 flex flex-row items-start gap-3">
        ...
        <div className="main-content mx-auto w-full overflow-hidden xl:max-w-[971px]">
          ...
          >
            {[
              {
                img1: "/imgs/sportPage/Rectangle 1071.png",
                img2: "/imgs/sportPage/Rectangle 1072.png",
              },
              {
                img1: "/imgs/sportPage/Rectangle 1073.png",
                img2: "/imgs/sportPage/Rectangle 1074.png",
              },
            ].map((image, i) => {
              return (
                <SwiperSlide
                  key={i}
                  className="mt-0 !flex h-fit w-fit flex-col gap-[13px] max-md:mt-8"
                >
                  <Image
                    src={image.img1}
                    width={100}
          ...
          <section className="gray round CardsSlider-p !mt-8 !pt-0 md:!mt-10">
            <div className="section-title !m-0 flex items-center !text-[#383838] max-md:!h-[35px] max-md:!bg-[#fff] max-md:!text-[13px] md:!pb-[10px] md:!pt-[5px]">
          ...
          <section className="my-8 max-md:my-10">
            <BannerSlider
              desktopBanners={ManSlimBanner}
              swiperClass={"slim-slider !mb-0 !mt-0"}
            />
              ...
              {data.map((e, i) => {
                return (
                  ...
                  >
                    <img
                      src={e.img}
                      className="mx-auto mb-1 aspect-square !w-full rounded-[12px] object-cover"
                      loading="lazy"
                      alt={e.name}
                    />
                    <p className="-mt-0.5 text-center text-[9px] font-[400] max-md:text-[13px] md:text-start xl:text-[14px]">
          ...
          <section>
            ...
            <div className="mt-10 !grid h-fit grid-cols-2 gap-[13px] max-md:mt-8 max-md:grid-cols-1">
              {[
          ...
          <section className="round PinkBigBrandSection kids mb-8 mt-8 !pb-8 !pl-[10px] !pr-[10px] !pt-0.5 md:mb-10 md:mt-10 md:!bg-[#FAFAFA]">
            <BlueBigBrand
              array={cheapSport}
              bgColor={"!bg-[#9CBBDD]"}
              textColor={"!text-[#fff]"}
              offerTextColor={"!text-[#fff]"}
              smallBannerImg={"/../imgs/womanWatches/65hh 4.png"}
              title="الجيم و الرياضة تناسب الميزانية"
            />
          </section>
          {/* 
          ...
          <section>
            ...
            <div className="bg-[#F5F5F5] p-[20px]">
              <BannerSlider
                desktopBanners={boysBanner}
                swiperClass={
                  "top-banner !rounded-[0] imageNoHeight aspect-[933/297]"
                }
                mobileBanners={mobileboysBanner}
              />
              <FramSmallSlider
          ...
          <section>
            <SectionTitle
              name={"اكسسوارات التدريب و  اللياقة"}
              color={"#383838"}
            />
            <SimpleLargeCardSlider
              products={[
                {
                  img: "/imgs/sportPage/image 335 (2).png",
          ...
          <section className="boysJewellery mt-[40px] max-md:mt-[32px]">
            <SectionTitle
              name={"تكنولوجيا الرياضة والترفيه"}
              color={"#383838"}
            />
            <SmartWatches
          ...
          */}
          {/* ------------ */}
          <section className="gray round CardsSlider-p !mt-8 !pt-0 md:!mt-10">
            <div className="section-title !m-0 flex items-center !text-[#383838] max-md:!h-[35px] max-md:!bg-[#F5F5F5] max-md:!text-[13px] md:!pb-[10px] md:!pt-[5px]">
